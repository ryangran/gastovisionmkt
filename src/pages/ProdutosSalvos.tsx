        ...
        {products.length === 0 ? (
          <Card className="border-dashed border-border bg-card/50">
            <CardContent className="text-center py-16">
              ...
              <p className="text-muted-foreground font-medium">Nenhum produto salvo ainda</p>
              <p className="text-sm text-muted-foreground mt-1">
                Calcule um produto na calculadora e clique em "Salvar"
              </p>
              <Button className="mt-6 gap-2" onClick={() => navigate("/calculadora")}>
          ...
          <div className="space-y-2">
            {/* Cabeçalho desktop */}
            <div className="hidden md:grid md:grid-cols-[1fr_130px_105px_105px_85px_105px_70px_36px] gap-3 px-4 py-2 text-xs font-medium text-muted-foreground uppercase tracking-wide">
              <span>Produto</span>
            ...
            {products.map((p) => (
              <Card
                key={p.id}
                className="border-border bg-card hover:bg-muted/30 transition-colors"
              >
                <CardContent className="py-3 px-4">
                  {/* Desktop */}
                  <div className="hidden md:grid md:grid-cols-[1fr_130px_105px_105px_85px_105px_70px_36px] gap-3 items-center">
